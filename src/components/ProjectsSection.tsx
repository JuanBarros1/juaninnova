            ...
            <div className="container mx-auto px-4 relative z-10">
                <div ref={headerRef} className="text-center mb-12 md:mb-24 relative">
                    <h2 className="text-4xl md:text-5xl lg:text-7xl font-black mb-6 tracking-tight">
                        <span className="text-foreground drop-shadow-2xl">My </span>
                        <span className="hero-gradient-text bg-clip-text text-transparent bg-gradient-to-r from-primary via-purple-400 to-accent">Projects</span>
                    </h2>
                    <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
                        Immersive digital experiences combining high-fidelity design with extreme performance.
                    </p>
                </div>
