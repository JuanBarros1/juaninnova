    ...
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button
              ...
              className="px-6 py-2 rounded-xl bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-medium shadow-lg hover:from-purple-400 hover:to-indigo-500 transition-all duration-300"
            >
              Get in Touch
            </button>
          </div>
      ...
      >
        <div className="px-4 py-4 space-y-3">
          ...
          <button
            onClick={() => scrollToSection('#contact')}
            className="w-full px-4 py-2 rounded-lg bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-medium"
          >
            Get in Touch
          </button>
        </div>
